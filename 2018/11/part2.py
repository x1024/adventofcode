...
def solve(seed):
  ...
  # for x in range(LIMIT): print(data[x])
  
  # for y in range(1, LIMIT): data[0][y] = data[0][y] + data[0][y-1]
  # for x in range(1, LIMIT): data[x][0] = data[x][0] + data[x-1][0]
